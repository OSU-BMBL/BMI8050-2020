...
cran_packages <- c(
  "survival","ClassComparison"
)
cran_np <- cran_packages[!(cran_packages %in% installed.packages()[,"Package"])]

# Installing all packages will take 20 mins, so here we only install two packages for the first two code chunks
# Ignore the error code 502
if(length(cran_np)) {
...
# setwd only works when typing in the console panel
# setwd("/fs/ess/PAS1791/course_code/predictive_modeling_0914/")
#knitr::opts_knit$set(root.dir = "/fs/ess/PAS1791/course_code/predictive_modeling_0914")
knitr::opts_knit$set(root.dir = "C:/Users/flyku/Documents/GitHub/BMI8050-2020/predictive_modeling")
...
You can find the archived verison of this document in the course GitHub repository: [Click here to open](https://github.com/OSU-BMBL/BMI8050-2020)

Files in the directory:

- predictive_modeling.rmd: R markdown version of Dr. Lianbo Yu's code
- predictive_modeling.html: R markdown output web page result
- brca.Rda: TCGA BRCA R dataset
- brca.clustering.group.Rd: Clustering group information for TCGA BRCA R dataset 
- Predictive Modeling_Rscript.R: Original R code provided from Dr. Lianbo Yu
- Predictive_Modeling_Rscript.html: Original R code web page output provided from Dr. Lianbo Yu
...
if (!file.exists("brca.Rda")) {
  download.file("https://bmbl.bmi.osumc.edu/downloadFiles/bmi8050/brca.Rda","brca.Rda")
}
load("brca.Rda")
...
## Load all packages to run the rest code
knitr::opts_chunk$set(echo = TRUE)
...
cran_packages <- c(
  "MASS","survival","penalized","glmnet","survAUC","timeROC","Hmisc","ClassComparison"
)
cran_np <- cran_packages[!(cran_packages %in% installed.packages()[,"Package"])]

# Installing all packages will take 20 mins
# Ignore the error code 502
if(length(cran_np)) {
  install.packages(cran_np)
}
